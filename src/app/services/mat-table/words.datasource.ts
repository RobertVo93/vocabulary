...
export class WordsDataSource implements DataSource<Words> {
    ...
    loadWords(courseId: number, filter: string, sortDirection: string, pageIndex: number, pageSize: number) {
        this.wordsService.getWordsByFilter(courseId, filter, sortDirection,
